...
<div>
<div class="title">
    <el-col :span="12"> BD管理 > 创建BD用户</el-col>
...
<script type="text/javascript">
	...
	export default {
		...
		methods:{
			...
			//取消
            cancelnow: function() {
                this.$router.push({ path: '/BD/index' })
            },
            ...
            submitnow(formName , GoOn) {
                ...
                this.$refs[formName].validate((valid) => { 
                    if (valid) {
                        ...
                        api.addBDLogic({'bduser':this.ruleForm}).then(res => {
                            loading.close()
                            if (res.ret != '0') {
                            ...
                            if(!GoOn && !this.setIdentity){
                                self.$router.push({ path: '/BD/index' })
