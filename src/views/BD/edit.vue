...
<div class="content-container">
    <el-form  :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px">
        ...
        <el-form-item label="身份证正面：" >
            <el-upload class="avatar-uploader" :name="fileName" :action=" _Config.API + '/upload ' " :show-file-list="false" :on-success="handleAvatarSuccess1" :before-upload="beforeAvatarUpload">
                <img v-if="imageUrl1" :src="imageUrl1" class="avatar">
                <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
        </el-form-item>
        <el-form-item label="身份证背面：" >
            <el-upload class="avatar-uploader" :name="fileName" :action=" _Config.API + '/upload ' "  :show-file-list="false" :on-success="handleAvatarSuccess2" :before-upload="beforeAvatarUpload">
                <img v-if="imageUrl2" :src="imageUrl2" class="avatar">
                <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
        </el-form-item>
        <el-form-item label="上传头像：" >
            <el-upload class="avatar-uploader" :name="fileName" :action=" _Config.API + '/upload ' "   :show-file-list="false" :on-success="handleAvatarSuccess3" :before-upload="beforeAvatarUpload">
		...
		methods:{
            ...
            getDefaultDate : function(strStoreId){
            	api.getBDInfo({strUserId:this.ruleForm.strUserId}).then(res => {
                    ...
                    this.imageUrl1 = baseInfo.strCardPicFront?this._Config.API + '/static/upload/' + baseInfo.strCardPicFront:''
                    this.imageUrl2 = baseInfo.strCardPicBack?this._Config.API + '/static/upload/' + baseInfo.strCardPicBack:''
                    this.imageUrl3 = baseInfo.strHeadPic?this._Config.API + '/static/upload/' + baseInfo.strHeadPic:''
                })
            },
