                ...
                <el-tab-pane label="Dealer详情">
                    <el-form :model="ruleForm" ref="ruleForm" label-width="150px">
                        ...
                        <el-form-item label="三证照片：" class='pic'>
                            <img v-if="ruleForm.dealer.strLicensePic" :src="_Config.API+ '/static/upload/' + ruleForm.dealer.strLicensePic">
                        ...
                        <el-form-item label="合作协议照片：" class='pic'>
                            <img v-if="ruleForm.dealer.strContractPic" :src="_Config.API+ '/static/upload/' + ruleForm.dealer.strContractPic">
                            <img v-else src="../../assets/images/no_img.png">
                        </el-form-item>
                        <p>4.合作状态</p>
                ...
                <el-tab-pane label="D4">
                    ...
                    <el-form v-else label-width="150px">
                        ...
                        <el-form-item label="身份证照片正面：" class='pic'>
                            <img v-if="DruleForm.baseinfo.strCardPicFront" :src="_Config.API+ '/static/upload/' + DruleForm.baseinfo.strCardPicFront">
                            <img v-else src="../../assets/images/no_img.png">
                        </el-form-item>
                        <el-form-item label="身份证照片背面：" class='pic'>
                            <img v-if="DruleForm.baseinfo.strCardPicBack" :src="_Config.API+ '/static/upload/' + DruleForm.baseinfo.strCardPicBack">
                            <img v-else src="../../assets/images/no_img.png">
                        </el-form-item>
                        <el-form-item label="头像照片：" class='pic'>
                            <img v-if="DruleForm.baseinfo.strHeadPic" :src="_Config.API+ '/static/upload/' + DruleForm.baseinfo.strHeadPic">
                            <img v-else src="../../assets/images/no_img.png">
                        </el-form-item>
                        <p>2.数据范围</p>
                        <br>
                        ...
                        <p>4.合作状态</p>
                        <el-form-item label="状态："><span>{{DruleForm.baseinfo.strStatusName}}</span></el-form-item>
                    </el-form>
                </el-tab-pane>
            </el-tabs>
            <div class="tool">
    ...
    methods: {
        ...
        getDefaultDate: function(strStoreId) {
            api.getDealerInfo({ dealerid: this.dealerid }).then(res => {
                ...
                this.imageUrl1 = this._Config.API + '/static/upload/' + msg.strLicensePic
                this.imageUrl2 = this._Config.API + '/static/upload/' + msg.strContractPic
