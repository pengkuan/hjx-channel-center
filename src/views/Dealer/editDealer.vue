		...
		methods:{
            ...
            getdefaultData : function(strStoreId){
            	api.getDealerInfo({dealerid:this.ruleForm.dealer.dealerid}).then(res => {
                    ...
                    this.imageUrl1 = msg.strLicensePic?this._Config.API+ '/static/upload/' + msg.strLicensePic:''
                    this.imageUrl2 =msg.strContractPic?this._Config.API+  '/static/upload/' + msg.strContractPic:''
