...
<style>
    ...
    .el-submenu .el-menu-item.is-active:hover, .el-menu-item.is-active:hover {background-color: #00C1DE;color: #fff;}

    .el-submenu .el-menu-item.is-active-add, .el-menu-item.is-active-add,
    .el-submenu .el-menu-item.is-active-add:hover, .el-menu-item.is-active-add:hover {background-color: #00C1DE;color: #fff;}
