<template>
    <div>
        <div class="title"> BD管理 > 批量创建BD {{pageDescribe}}</div>
        <div class="step-1" v-if="steps.step_1">
            ...
            <div class="hjx-fl">
                ...
                <div class="step-choose-file">
                    ...
                    <br>
                    <br>
                    <el-upload class="upload-demo" :name="fileName" :limit="limit" ref="upload"  :on-change="verification" :on-exceed="handleExceed" :on-remove="reChooseFile" :action=" apiRoot + '/upload' " :file-list="fileList" :on-success="successUpload"  :auto-upload="false">
                        <el-button slot="trigger" size="small" type="primary" :disabled="hasChoosed">选取文件</el-button>
        ...
        <div class="step-2-success" v-else-if="steps.step_2_success">
            ...
            <!-- fffffffff -->
            <!-- <el-table :data="step2_success_data.rowList" border style="width: 100% ;">
                <el-table-column label="行数" type="index">
                </el-table-column>
                ...
                <el-table-column prop=""  label="校验结果">
            ...
            <p class="hjx-center">
                ...
                <el-button type="primary" @click="reChooseFile" size="small">取消</el-button>
            </p>
        </div>
        <!-- 提交失败页 -->
        <div class="step-2-fail" v-else-if="steps.step_2_fail">
            <div class="hjx-alert hjx-alert-warning" >
                ...
                <span class="hjx-danger">（如有误，请调整excel后全部重新上传；第102行及之后的数据未做校验）</span>
            </div>
            <br>
            <el-table :data="step2_fail_data.rowList" border style="width: 100% ;">
                ...
                <el-table-column prop="phonenum" label="手机号"></el-table-column>
                <el-table-column prop="cardnum" label="身份证号码"></el-table-column>
                <el-table-column prop="errinfo" label="错误详情"></el-table-column>
            </el-table>
            <br>
            <p class="hjx-center">
                <el-button type="primary" @click="reChooseFile" size="small">重新上传</el-button>
            </p>
        </div>
        <!-- 创建成功（部分） -->
        <div class="step-3-mostSuccess" v-else-if="steps.step_3_most">
            ...
            <div class="hjx-alert hjx-alert-warning" >
                ...
                <span class="hjx-danger">{{step3_most_data.errorNum}}条发现与已有数据重复，请检查（第102行及之后的数据未做校验）：</span>
            </div>
            <br>
        ...
        <div class="step-3 hjx-center" v-else>
            ...
            <p class="hjx-ft13 hjx-danger ">（第102行及之后的数据未做校验）</p>
            <br>
            <br>
            <router-link to="index">
                <el-button size="middle">完成</el-button>
    ...
    methods: {
        ...
        verification(file, fileList) {
            ...
            if (getFileNameInfo[0] != this.fixedName) {
                this.upload__tip = ' 选择文件失败，请确认文件名为“批量新建BD”'
